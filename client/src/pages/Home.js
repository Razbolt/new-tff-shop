  ...
  const sortedBySold = arr?.sort((a,b) => (a.sold < b.sold ? 1 : -1));
    ...
    return (
     <div>
        ...
        {products && products.length < total && ( <button className="btn btn-warning btn-lg col-md-6" disabled = {loading} onClick={e => {e.preventDefault(); setPage(page+1);}} >{loading ? 'Loading...':'Load more'}</button>) }
