...
export default function Register() {
    ...
    return (
     <div>
        <Jumbotron title = "Register" subtitle ="Welcome to  TFF Register page " />
      ...
      <div className="container mt-5">
        ...
        <div className="row">
            ...
            <div className="col-md-6 offset-md-3">
                ...
                <input type ="text" className="form-control mb-4 p-2" placeholder="Enter your name" value={name} onChange ={(e) => setName(e.target.value)}/>
